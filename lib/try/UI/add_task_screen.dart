...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  Future<void> _selectDate(
    ...
    if (picked != null) {
      setState(() {
        controller.text = picked.toIso8601String(); // Use a standardized format
      });
    }
  }
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                readOnly: true,
                onTap: () => _selectDate(context, _createdDateController),
                validator: (value) {
                  if (value?.isEmpty ?? true) {
              ...
              TextFormField(
                ...
                readOnly: true,
                onTap: () => _selectDate(context, _lastUpdateController),
              ),
              TextFormField(
                controller: _lastViewDateController,
                decoration: InputDecoration(labelText: 'Last View Date'),
                readOnly: true,
                onTap: () => _selectDate(context, _lastViewDateController),
              ),
              TextFormField(
