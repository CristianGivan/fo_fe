...
//
// class TaskModelDel extends TaskEntity {
//   TaskModelDel({
//     int? id,
//     String? subject,
...
//         );
//
//   static TaskModelDel empty() {
//     return TaskModelDel();
//   }
//
// // todo to be uodated see how it can be puteed in all other sub classes?
//   factory TaskModelDel.fromJson(Map<String, dynamic> json) {
//     return TaskModelDel(
//       startDate:
...
// //     creator: creatorId ?? this.creatorId,
