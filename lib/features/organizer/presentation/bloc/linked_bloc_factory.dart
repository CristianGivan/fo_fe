...
//
// OrganizerLinkBloc<T> createLinkedBloc<T extends ItemEntity>(ItemsTypeEnum itemType) {
//   switch (itemType) {
//     case ItemsTypeEnum.taskUser:
//       return _getUserBloc();
//     case ItemsTypeEnum.taskTag:
//       return _getLinkedTagBloc<T>();
//     default:
//       throw UnsupportedError('Unsupported itemType: $itemType');
//   }
// }
//
// OrganizerLinkBloc<T> _getLinkedTagBloc<T extends ItemEntity>() {
//   return TagBloc(
//     addItem: GetIt.instance.get(),
//     deleteItems: GetIt.instance.get(),
//     getItems: GetIt.instance.get(),
//   );
// }
//
// dynamic _getUserBloc<T extends ItemEntity>() {
//   return UserBloc(
