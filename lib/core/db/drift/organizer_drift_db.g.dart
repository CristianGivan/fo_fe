...
typedef $$UserUserTableDriftTableInsertCompanionBuilder
...
class $$UserUserTableDriftTableTableManager extends RootTableManager<
    ...
    $$UserUserTableDriftTableProcessedTableManager,
    $$UserUserTableDriftTableInsertCompanionBuilder,
  ...
  $$UserUserTableDriftTableTableManager(
      ...
      : super(TableManagerState(
          ...
          orderingComposer: $$UserUserTableDriftTableOrderingComposer(
              ComposerState(db, table)),
          getChildManagerBuilder: (p) =>
              $$UserUserTableDriftTableProcessedTableManager(p),
          getUpdateCompanionBuilder: ({
            Value<int> id = const Value.absent(),
            Value<DateTime> linkingDate = const Value.absent(),
            Value<int> userId = const Value.absent(),
...
class $$UserUserTableDriftTableProcessedTableManager
    extends ProcessedTableManager<
        _$OrganizerDriftDB,
        $UserUserTableDriftTable,
        UserUserTableDriftG,
        ...
        $$UserUserTableDriftTableInsertCompanionBuilder,
        $$UserUserTableDriftTableUpdateCompanionBuilder> {
  $$UserUserTableDriftTableProcessedTableManager(super.$state);
}
