    ...
    return GoRouter(
      ...
      routes: [
        StatefulShellRoute.indexedStack(
          ...
          branches: [
            AppHomeBranch.branch(_homeShellNavigatorKey), // Home branch
            AuthenticationAppBranch.branch(_authShellNavigatorKey), // Authentication branch
            OrganizerAppBranch.branch(_organizerShellNavigatorKey), // Organizer branch
            PracticeAppBranch.branch(_practiceShellNavigatorKey), // Practice branch
            SettingsAppBranch.branch(_settingsShellNavigatorKey), // Settings branch
          ],
        ),
      ],
    );
