...
import 'core/db/objectbox/model.dart';

export 'package:objectbox/objectbox.dart'; // so that callers only have to import this file

final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 5735795579823374075),
      name: 'Event',
      lastPropertyId: const IdUid(4, 6502335330767450180),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 4607110769923732927),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 6529364470559083335),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 8377820518789455468),
            name: 'date',
            type: 10,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 6502335330767450180),
            name: 'location',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 5201131681681810458),
      name: 'Owner',
      lastPropertyId: const IdUid(2, 1455233171597280513),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6505559489564168971),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 1455233171597280513),
            name: 'name',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(3, 4787668857948876254),
      name: 'Task',
      lastPropertyId: const IdUid(4, 4846626173629698775),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 4296137058567386666),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 4239757816560296528),
            name: 'text',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 1092399789920343667),
            name: 'status',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 4846626173629698775),
            name: 'eventId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 312188718052203151),
            relationTarget: 'Event')
      ],
      relations: <ModelRelation>[
        ModelRelation(
            id: const IdUid(1, 5265604644370606355),
            name: 'owner',
            targetId: const IdUid(2, 5201131681681810458))
      ],
      backlinks: <ModelBacklink>[])
];
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(3, 4787668857948876254),
      lastIndexId: const IdUid(1, 312188718052203151),
      lastRelationId: const IdUid(1, 5265604644370606355),
